...
{
    [RoutePrefix("DongBoSL")]
    public class DongBoSLController : ApiController
    {
        [Route("ADD_DEL_PASS")]
        [HttpGet]
        public async Task<IHttpActionResult> AddDelPass(string Mobile,string Password, string P_NhanVien,string P_Account,Int64 P_Slot,Int64 P_Port,Int64 P_Vpi)
        {
          if( !Datacs.IsValidMobile(Mobile,Password))
            {
                return Unauthorized();
            }
        ...
        [HttpGet]
        public async Task<IHttpActionResult> GetDichVuByAccount(string Mobile, string Password,string P_Account)
        {
        ...
        [Route("GET_DSKH")]
        [HttpGet]
        public async Task<IHttpActionResult> GetDSKH(string Mobile, string Password,string Smadv,string skey)
        {
            if (!Datacs.IsValidMobile(Mobile, Password)) return Unauthorized();
            List<OracleParameter> param = new List<OracleParameter>();
        ...
        [HttpGet]
        public async Task<IHttpActionResult> GetLogByAccount(string mobile, string password, string P_Account)
        {
            if (!Datacs.IsValidMobile(mobile, password)) return Unauthorized();
            List<OracleParameter> param = new List<OracleParameter>();
            OracleParameter p1 = new OracleParameter("P_ACCOUNT", OracleDbType.Varchar2);
        ...
        [Route("LIST_TBDC_KH")]
        [HttpGet]
        public async Task<IHttpActionResult> ListTBDCKH(string Mobile,string Password,string SDevice)
        {
            if (!Datacs.IsValidMobile(Mobile, Password)) return Unauthorized();
            List<OracleParameter> param = new List<OracleParameter>();
        ...
        [HttpGet]
        public async Task<IHttpActionResult> ListTBYCUpload(string Mobile, string Password, string Smatt,string Stt_Dslam)
        {
            if (!Datacs.IsValidMobile(Mobile, Password)) return Unauthorized();
            List<OracleParameter> param = new List<OracleParameter>();
        ...
        [HttpGet]
        public async Task<IHttpActionResult> ListYCXNUpload(string Mobile, string Password,string Smadv)
        {
            if (!Datacs.IsValidMobile(Mobile, Password)) return Unauthorized();
            List<OracleParameter> param = new List<OracleParameter>();
            OracleParameter p1 = new OracleParameter("SMADV", OracleDbType.Varchar2);
        ...
        [Route("XN_UPLOAD")]
        [HttpGet]
        public async Task<IHttpActionResult> XNUpload(string Mobile, string Password,string Lsacc,string Lsp_Onu,string Smatt,string Spass_Onu,string Sonu_Id, string SNV,string Stb_Dcoui)
        {
            if (!Datacs.IsValidMobile(Mobile, Password)) return Unauthorized();
            List<OracleParameter> param = new List<OracleParameter>();
